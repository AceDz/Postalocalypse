...
{
    [CreateAssetMenu(menuName = "_Delivery/Items/UsbKeyItem")]
    public class UsbKeyItem : SerializedScriptableObject, IPickable, IMaxedItem, IUnlockable
    {
        [SerializeField, BoxGroup("Usb Keys")] 
